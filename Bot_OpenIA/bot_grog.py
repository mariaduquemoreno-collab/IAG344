import logging #liberia para mostrar que esta pasando en la consola#
import asyncio #  libreria multitarea, puede hacer varias coosas al mismo tiempo#
from collections import defaultdict, deque # definen una linea de llegada y da la facultad de responder#

from groq import Groq # para conectarse groq#
